...
##############################
# 리스트 d의 0번째는 사용되지 않는다.
# a[i]에 입력되는 숫자가 0이 아닌 1부터 시작하기 때문이다.
# 때문에 d는 24개 요소가 필요하다. (1 ~ 23)
##############################

n = int(input())
a = list(map(int, input().split()))
d = list(0 for i in range(0, 24))

# 리스트 d는 0은 빈 값으로 들어간다. a[i]에 입력되는 숫자가 0이 아닌 1부터 시작하기 때문이다.
for i in range(n):
    d[a[i]] += 1
